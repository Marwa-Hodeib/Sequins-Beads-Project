...
const start = async () => {
  ...
  app.get("/collection/delete/id/:ID", async (req, res, next) => {
    try {
      const result = await controller.deleteCollectionByID(req.params.ID);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/collection/delete/name/:name", async (req, res, next) => {
    try {
      const result = await controller.deleteCollectionByName(req.params.name);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/collection/create/", async (req, res, next) => {
    try {
      const result = await controller.createCollection(req.query);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/category/delete/id/:ID", async (req, res, next) => {
    try {
      const result = await controller.deleteCategoryByID(req.params.ID);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/category/delete/name/:name", async (req, res, next) => {
    try {
      const result = await controller.deleteCategoryByName(req.params.name);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/category/create/", async (req, res, next) => {
    try {
      const result = await controller.createCategory(req.query);
      res.json(result);
    } catch (err) {
      next(err);
    }
  ...
  app.get("/category/update/:ID", async (req, res, next) => {
    try {
      const result = await controller.updateCategory(req.params.ID, req.query);
      res.json(result);
    } catch (err) {
      next(err);
    }
